...
import com.lin.linusercenterbackend.model.request.*;
...
import static com.lin.linusercenterbackend.constant.UserConstant.ADMIN_ROLE;
import static com.lin.linusercenterbackend.constant.UserConstant.USER_LOGIN_STATE;
...
@RequestMapping("/user")
@Api(tags = "用户管理")
@CrossOrigin(origins = "http://user.lilinking.top/", allowCredentials = "true")
